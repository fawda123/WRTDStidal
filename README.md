...
Linux: [![Travis-CI Build Status](https://travis-ci.org/fawda123/wtreg_for_estuaries.png?branch=master)](https://travis-ci.org/fawda123/wtreg_for_estuaries)

Windows: [![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/fawda123/wtreg_for_estuaries?branch=master)](https://ci.appveyor.com/project/fawda123/wtreg_for_estuaries)
