...
#' 
#' @return The original data frame with additional columns for the random errors (\code{errs}) and the standard error estimates for each residual (\code{scls}).
#' 
#' @export
#' 
...
#' lnres_err(daydat)
#'}
lnres_err <- function(dat_in, yr = NULL) {
