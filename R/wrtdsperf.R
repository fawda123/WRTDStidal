...
#' 
#' @return A tidal object with performance metrics as an additional attribute named 'perf'
#' 
#' @references 
...
wrtdsperf.tidal<- function(tidal_in, ...){
  ...
  # get residuals, make long format by type
  ...
  # add attribute to tidal_in
  attr(tidal_in, 'perf') <- perf
