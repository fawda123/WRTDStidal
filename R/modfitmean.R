######
#' Fit weighted regression and get predicted/normalized chlorophyll for the conditional mean model
#'
...
#' }
modfitmean <- function(dat_in, ...) UseMethod('modfitmean')

#' @rdname modfitmean
#'
#' @export
#'
#' @method modfitmean data.frame
modfitmean.data.frame <- function(dat_in, ...){
  ...
  dat <- do.call(wrtdsmean, args)
  
  # update args, get predictions
  args[['tidal_in']] <- dat
  dat <- do.call(chlpredmean, args)
  
  # get normalized predictions
  args[['tidal_in']] <- dat
  dat <- do.call(chlnormmean, args)
